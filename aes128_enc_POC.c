...
uint8_t rci[11] = {0x00,0x01,0x02,0x04,0x08,0x10,0x20,0x40,0x80,0x1b,0x36};

//Galois Multiplication Table
/*
    Galois multiplication is bitwise polynomial multiplication mod x^8 + x^4 + x^3 + x + 1.
    You take two numbers, express them into bits, and write them as polynomials with
    the bits as coefficients, multiply the polynomials, and take the remainder as you divide
    by the 8th degree polynomial given.

    Since this operation is quite tedious to program, the following loop-up tables are used to
    find the result when multiplied by 2 and 3.
*/
uint8_t table_2[256] = {0x00,0x02,0x04,0x06,0x08,0x0a,0x0c,0x0e,0x10,0x12,0x14,0x16,0x18,0x1a,0x1c,0x1e,
...
uint8_t table_3[256] = {0x00,0x03,0x06,0x05,0x0c,0x0f,0x0a,0x09,0x18,0x1b,0x1e,0x1d,0x14,0x17,0x12,0x11,
